...
try:
    ...
    core = DeferredError.new(ImportError(
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def remap_palette(self, dest_map, source_palette=None):
        ...
        m_im.im.putpalette(palette_mode, palette_mode +
                           ";L", m_im.palette.tobytes())
    ...
    def save(
        ...
        ext = filename_ext.decode() if isinstance(
            filename_ext, bytes) else filename_ext
    ...
    def thumbnail(
        ...
        if reducing_gap is not None:
            ...
            res = self.draft(
                None, (int(size[0] * reducing_gap),
                       int(size[1] * reducing_gap))
            )
            if res is not None:
                box = res[1]
        if box is None:
        ...
        if self.size != final_size:
            im = self.resize(final_size, resample, box=box,
