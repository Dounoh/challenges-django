...
from .send_mail import sender_mail,sender_mail_reset_password
from .forms import CreateUserForm,CustomeAuthenticate,ForgotPasswordForm
from .forms import NewPasswordForm,UpdateUserForm
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.success(request,'Un mail de reinitialisation vous a ete envoyer avec succes')
...
class EditProfilView(UpdateView):
    ...
    def form_valid(self, form):
        messages.success(self.request,'Votre profil a été modifier avec success')
