...
class Critique(models.Model):
    film = models.ForeignKey('movie.Film',on_delete=models.CASCADE, related_name='critiques')
    user = models.ForeignKey(User,on_delete=models.CASCADE, related_name='critiques_user')
...
class LikeDislike(models.Model):
    ...
    film = models.ForeignKey('movie.Film',on_delete=models.CASCADE, related_name='like_film')
